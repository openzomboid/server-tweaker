...
* **HideTradeWithInvisiblePlayers** `(default=true)` - hides trade option with invisible players. This is a fix to vanilla bug that allows players to detect invisible admins. This option is enabled by default, but it is recommended to enable it.
