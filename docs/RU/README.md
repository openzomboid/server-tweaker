...
## Existing saves
Мод полностью совместим с существующим сохранением и безопасен для удаления.

## Compatibility
Версия игры: Build 41.78+ (Multiplayer)  
В моде практически нет грубого патчинга с полной заменой кода ванильных функций поэтому предполагается хорошая совместимость со всеми модами из мастерской.
