...
ShowCoordinates = {
    OriginalFunctions = {
        ISCharacterScreen_render = ISCharacterScreen.render
    }
}

-- ISCharacterScreen_render overrides the original ISCharacterScreen:render() function.
-- Adds characters coordinates.
ShowCoordinates.ISCharacterScreen_render = function(self)
    ShowCoordinates.OriginalFunctions.ISCharacterScreen_render(self)

    if not SandboxVars.ServerTweaker.ShowCoordinates then
        return
    end
...
ISCharacterScreen.render = ShowCoordinates.ISCharacterScreen_render
